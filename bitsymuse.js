...
var hackOptions = {
	...
	audio: {
		...
		'E': { src: 'E.wav', volume: 1.0 },
		'F': { src: 'F.wav', volume: 1.0 },
		'G': { src: 'G.wav', volume: 1.0 },
		'adam': { src: 'adam.wav' },
		'beatriz': { src: 'beatriz.wav' },
		'bernart': { src: 'bernart.wav' },
		'blanche': { src: 'blanche.wav' },
		'crumhorn': { src: 'crumhorn.wav' },
		'harp': { src: 'harp.wav' },
		'king': { src: 'king.wav' },
		'cow': { src: 'cow.wav' },
		'monk': { src: 'monk.wav' },
		'hurdygurdy': { src: 'hurdygurdy.wav' },
		'lute': { src: 'lute.wav' },
		'organ': { src: 'organ.wav' },
		'recorder': { src: 'recorder.wav' },
		'sackbut': { src: 'sackbut.wav' },
		'tabor': { src: 'tabor.wav' },
		'walther': { src: 'walther.wav' }
